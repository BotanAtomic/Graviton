    ...
    public String launch(String line) {
        switch (line.toLowerCase()) {
            ...
            case "infos":
                ...
                builder.append(";Number of players : ").append(gameManager.getElements(DataType.PLAYER).size());
    ...
    private void execute(String line) {
        ...
        switch (line.toLowerCase()) {
            ...
            case "infos":
                ...
                System.out.println("| Number of players : " + gameManager.getElements(DataType.PLAYER).size());
